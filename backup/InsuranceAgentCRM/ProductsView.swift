        ...
        Button(action: onTap) {
            HStack {
                ...
                VStack(alignment: .trailing, spacing: 4) {
                    ...
                    Text(formatCurrency(product.basePremium))
                        .font(.headline)
                        .foregroundColor(.primary)
                }
            }
...
struct AddProductView: View {
    ...
    private func saveProduct() {
        ...
        product.description = description.isEmpty ? nil : description
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        InfoRow(label: "Base Premium", value: formatCurrency(product.basePremium))
...
struct EditProductView: View {
    ...
    init(product: Product) {
        ...
        _basePremium = State(initialValue: product.basePremium)
...
struct QuoteBuilderView: View {
    ...
    var body: some View {
        ...
        .onChange(of: coverageAmount) { _ in updateFinalPremium() }
        .onChange(of: selectedRiders) { _ in updateFinalPremium() }
        .onChange(of: discount) { _ in updateFinalPremium() }
    }
    
    private func calculateFinalPremium() -> Decimal {
        var premium = product.basePremium
    ...
    private func saveQuote() {
        ...
        quote.coverageAmount = coverageAmount
        quote.selectedRiders = selectedRiders.isEmpty ? nil : selectedRiders
        quote.discount = discount
        quote.finalPremium = finalPremium
        quote.status = "draft"
